...
class SceneBoot extends Phaser.Scene {
    ...
    preload(){
        ...
        this.load.image("UIMarsTuto", directory+"TUTORIAL_MARTE.png" );
        this.load.image("UIMarsStormPilot", directory+"UI_Mars_StormDangerPilot.png" );
        this.load.image("UIMarsMeteorPilot", directory+"UI_Mars_MeteorDangerPilot.png" );
        ...
        this.load.image("UIEarthTuto", directory+"TUTORIAL_TIERRA.png" );
        this.load.image("UIEarthStormDanger", directory+"UI_Tierra_StormDanger.png" );
        this.load.image("UIEarthMeteorDanger", directory+"UI_Tierra_MeteorDanger.png" );
        ...
        //MUSICA
        this.load.audio('MusicMenu', ['./Resources/Audio/Music/space walk.mp3']);
        this.load.audio('MusicIngame', ['./Resources/Audio/Music/Pioneers meets Space.mp3']);
        this.load.audio('MusicTutorial', ['./Resources/Audio/Music/Roboxel - Space Music.mp3']);
